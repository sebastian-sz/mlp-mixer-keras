"""Script to test whether locally converted weights are OK."""
...
LOCAL_FEATURE_EXTRACTION_TEST_PARAMS = [
    ...
    {
        "testcase_name": "l16-imagenet1k-fe",
        "model_fn": MLPMixer_L16,
...
class TestKerasVSOriginalOutputConsistency(parameterized.TestCase):
    ...
    @parameterized.named_parameters(LOCAL_CONSISTENCY_TEST_PARAMS)
    def test_local_weights_for_output_consistency(
